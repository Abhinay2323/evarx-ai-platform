  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-8 sm:py-10">
      <PageHeader
        ...
        description="The medical SLM that makes Evarx, Evarx — fine-tuned on your data, CPU-runnable, deployable inside your perimeter."
        actions={
          <span className="inline-flex items-center rounded-full border border-amber-400/40 bg-amber-400/10 px-2 py-0.5 text-[10px] uppercase tracking-wider text-amber-200">
            Work in progress
          </span>
        }
      />
      ...
      <div className="rounded-2xl border border-amber-400/20 bg-amber-400/5 px-5 py-4 text-sm text-amber-100">
        ...
        <p className="mt-1 text-amber-200/80">
          ...
          in-house pipeline (below) is wired into the console, you'll be able to
          kick off a job from this page using the documents you've already
