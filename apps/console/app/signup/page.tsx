...
export const metadata = { title: "Create account · Evarx Console" };
    ...
    <div className="flex min-h-screen items-center justify-center bg-ink-950 px-4 py-12">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="mt-3 text-sm text-zinc-400">Create your console account</p>
        </div>
        ...
        <p className="text-center text-sm text-zinc-500">
          ...
          <Link href="/login" className="text-helix-300 hover:text-helix-200">
            Sign in
          </Link>
        </p>
      </div>
